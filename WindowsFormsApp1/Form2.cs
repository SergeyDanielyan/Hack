    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (FormInfo.startOfGame)
            {
                ...
                {
                    MessageBox.Show("Вы ввели неправильное число. Начните игру заново.", "Ошибка!");
                    Environment.Exit(0);
                }
            }
            else if (FormInfo.questionClass)
            {
                ...
                {
                    MessageBox.Show("Вы ввели правильный ответ. Вы получаете 20 баллов.", "Поздравляем!");
                    FormInfo.userPoints[FormInfo.number] += 20;
                }
                else
                {
                    FormInfo.userPoints[FormInfo.number] -= 20;
                    MessageBox.Show($"Вы ввели неправильный ответ. Правильный ответ - {readAnswer4Class[number4Class - 1]}. Вы теряете 20 баллов.", "Неудача!");
                }
                FormInfo.number++;
            ...
            else
            {
                if (answer.Text == readAnswer5Class[number5Class - 1])
                {
                    ...
                    MessageBox.Show("Вы ввели правильный ответ. Вы получаете 40 баллов.", "Поздравляем!");
                    FormInfo.userPoints[FormInfo.number] += 40;
                }
                else
                {
                    FormInfo.userPoints[FormInfo.number] -= 40;
                    MessageBox.Show($"Вы ввели неправильный ответ. Правильный ответ - {readAnswer5Class[number5Class - 1]}. Вы теряете 40 баллов.", "Неудача!");
                }
                FormInfo.number++;
                if (FormInfo.number >= FormInfo.numberOfPlayers)
                {
